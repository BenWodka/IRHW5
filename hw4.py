...
def main(inputDirectory, outputDirectory):
   ...
   #statistics about the collection
    ...
    writeIndexFiles(globalHT, dfTracker, numDocuments, outputDirectory, docTokenCounters)
...
def writeIndexFiles(globalHT, dfTracker, numDocuments, outputDirectory, docTokenCounters):
    ...
    for idx in range(globalHT.size):
        ...
        if pair.key != '':
            ...
            DictFile.writeRecord(term, len(postings), start)
            ...
            for posting in postings:
                ...
                tf_idf = rtf * idf
                PostFile.writeRecord(posting.docID, tf_idf)
